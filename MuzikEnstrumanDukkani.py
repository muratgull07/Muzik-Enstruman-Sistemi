...
class MusteriBilgileri(QWidget):
    ...
    def musteri_listesini_guncelle(self):
        ...
        for satis in self.satislar:
            ...
            self.musteri_listesi.item(self.musteri_listesi.count() - 1).setFont(font)
...
class MuzikDukkani(QWidget):
    def __init__(self):
        ...
        self.enstrumanlar = [
            Enstruman("Gitar", 10, 500),
            Enstruman("Piyano", 5, 3000),
            Enstruman("Davul", 8, 1000),
            Enstruman("Keman", 15, 700),
            Enstruman("Saksafon", 7, 1200),
            Enstruman("Flüt", 12, 400),
            Enstruman("Trompet", 6, 800),
            Enstruman("Klarnet", 9, 600),
            Enstruman("Elektro Gitar", 11, 900),
            Enstruman("Bas Gitar", 4, 1500),
            Enstruman("Tambur", 6, 1100),
            Enstruman("Bateri", 8, 2000),
            Enstruman("Org", 3, 2500)
        ]
    ...
    def arayuzu_olustur(self):
        ...
        self.enstruman_ekle_input.setStyleSheet("padding: 8px;")
        ...
        self.enstruman_ekle_button.setStyleSheet("background-color: #c63989; color: white; padding: 10px 24px; font-size: 16px; border: none; border-radius: 5px;")  # CSS stili ekle
        ...
        self.siparis_butonu.setStyleSheet(
            "background-color: #c63943; color: white; padding: 10px 24px; font-size: 16px; border: none; border-radius: 5px;")  # CSS stilini ekle
        ...
        self.destek_talebi_butonu.setStyleSheet(
            "background-color: #c63943; color: white; padding: 10px 24px; font-size: 16px; border: none; border-radius: 5px;")
        ...
        self.musteri_bilgileri_butonu.setStyleSheet("background-color: #4CAF50; color: white; padding: 10px 24px; font-size: 16px; border: none; border-radius: 5px;")  # CSS stili ekle
        ...
        self.satilan_enstrumanlar_butonu.setStyleSheet("background-color: #4CAF50; color: white; padding: 10px 24px; font-size: 16px; border: none; border-radius: 5px;")  # CSS stili ekle
        ...
        self.layout.addWidget(self.satilan_enstrumanlar_butonu)
            ...
            for enstruman in self.enstrumanlar:
                if enstruman.ad == secilen_enstruman:
                    if enstruman.stok >= adet:
                        enstruman.stok -= adet
                        self.enstruman_listesini_guncelle()
                        satis_numarasi = len(self.satislar) + 1
